  ...
  return (
    <div className='mt-32 text-stone-100'>
        <Parallax blur={2} strength={600} bgImage={Image}>
            <div className="h-fit flex flex-col justify-center items-center mt-32 mb-32 max-w-3xl mx-auto text-center animate">
                <h2 className='font-bold text-xl'>Coming Soon...</h2>
                <h1 className='text-3xl font-bold text-center mt-10 relative'>EARTH ANGELS TRANSFORMATIONAL WELLNESS
                <hr
                    style={{
                    background: 'orange',
                    color: 'orange',
