...
export default function KnowMore() {
  return (
    <div className='h-fit flex flex-wrap justify-center bg-zinc-800 text-stone-300'>
        <div className="flex flex-col lg:flex-row flex-wrap justify-between gap-20 max-w-6xl mb-10 mr-2 ml-2 sm:ml-0 sm:mr-0">
            ...
            <div className="flex-1 justify-center lg:mt-20">
                <CardContainer className="inter-var">
                    <CardBody className="bg-gray-50 relative w-auto sm:w-[35rem] h-auto sm:h-[25rem] rounded-xl shadow-xl">
