    ...
    <div className='relative'>
        ...
        <div className="flex justify-between gap-10 max-w-6xl mt-24 text-center mx-auto">
            <div className="flex-1 flex-col text-stone-700">
                ...
                <h2 className='font-bold text-xl mt-4'>Professional 'Turn-Key' Design</h2>
            ...
            <div className="flex-1 text-stone-700">
                <img src={Image} alt="image" className='rounded-lg shadow-lg'/>
                <h2 className='font-bold text-xl mt-4'>Sustainability in Action - Hospitality support (Tourism Projects)</h2>
