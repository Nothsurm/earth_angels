      ...
      <h1 className='flex justify-center text-4xl font-bold mt-20'>WHAT WE DO...</h1>
        <div className="flex flex-wrap flex-col md:flex-row justify-between gap-10 max-w-6xl mt-10 text-center mx-auto">
            <div className="flex-1 flex-col text-stone-700 mr-2 ml-2 sm:ml-0 sm:mr-0">
              ...
              <h2 className='font-bold text-xl'>Professional Design</h2>
              <p className='leading-loose p-6 mt-4'>We work closely with our clients to design & deliver bespoke solutions that are unique, energy efficient, eco & sustainable and set within nature. We are focused on delivering a carefully considered luxurious experience to budget.<br></br><br></br>
            ...
            <div className="flex-1 flex-col text-stone-700 mr-2 ml-2 sm:ml-0 sm:mr-0">
              <CardContainer className="inter-var">
                ...
                <h2 className='font-bold text-xl'>Design Visualisations</h2>
                <p className='leading-loose p-6'>Design visualisations can transform a space by helping you see options before you decide on a final design, to make informed decisions that maximise functionality, comfort and style.<br></br><br></br>
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-between gap-10 max-w-6xl mt-10 text-center mx-auto">
            ...
            <div className="flex-1 flex-col text-stone-700 mr-2 ml-2 sm:ml-0 sm:mr-0">
              <CardContainer className="inter-var">
                ...
                <h2 className='font-bold text-xl'>Sustainable Solutions</h2>
                <p className='leading-loose p-6'>We champion modern methods of manufacture and build. This technique is the Future, a significant and measurable sustainable approach.<br></br><br></br>
