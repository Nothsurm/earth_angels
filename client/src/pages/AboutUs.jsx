...
import LouisaImage from '../images/louisa-image.jpeg'
import JeremyImage from '../images/Jeremy-image.jpeg'
    ...
    <div>
        ...
        <div className="text-stone-100" style={myStyle}>
            <div className="h-fit flex flex-col gap-20 max-w-2xl ml-2 mr-2 lg:ml-40">
              ...
              <div className="leading-loose text-xl  font-semibold flex flex-col gap-10 mb-20">
                ...
                <img src={LouisaImage} alt="" className='w-[27rem] h-[30rem] rounded-md hover:scale-105 transition duration-300'/>
                ...
                <p>The founder of Earth Angels, Louisa, is a commercially astute Design professional.</p>
                <img src={JeremyImage} alt="" className='w-[27rem] h-[30rem] rounded-md hover:scale-105 transition duration-300'/>
                ...
                <p className='mt-10'>Check out our <Link to='/' className='underline hover:text-stone-400'>Portfolio</Link> work</p>
              </div>
            </div>
        </div>
    </div>
