  ...
  return (
    <div>
        ...
        <div className="text-stone-100" style={myStyle}>
            <div className="h-fit flex flex-col gap-20 mx-auto lg:ml-auto lg:mr-96 max-w-xl mr-2 ml-2 sm:ml-0 sm:mr-0">
              <p className='mt-20 text-2xl font-semibold leading-relaxed'>Earth Angels supports developers, real estate agencies, home builders, and homeowners in the shared goal of promoting sustainable communities. Above all, we are dedicated to creating a sustainable future by supporting people, strengthening communities, and protecting the environment on which we all depend.</p>
              <p className='text-2xl font-semibold leading-relaxed'>We have detailed knowledge and experience of sustainability in the Built Environment and we champion the design movement known as 'Wellness Architecture' (aka 'Wellness Design' or 'Wellness Real Estate').</p>
              <div className="bg-zinc-700 bg-opacity-75 p-2 rounded-md text-2xl text-center flex flex-col gap-10 mb-20">
                ...
                <p className='font-semibold'>Human health, wellbeing and comfort are key design considerations that augment a foundation rooted in sustainable and regenerative design practices.</p>
              </div>
            </div>
        </div>
        ...
        {/* SECTION 4 */}
        <div className="text-stone-100" style={myStyle}>
          <div className="h-fit flex flex-col gap-20 mx-auto lg:mr-auto lg:ml-96 max-w-xl mr-2 ml-2 sm:ml-0 sm:mr-0 text-center">
            <h1 className='mt-20 text-2xl font-bold uppercase'>Our Approach to Sustainability</h1>
            <div className="text-2xl font-semibold flex flex-col gap-20 mb-20">
              ...
              <img src={Image} alt="" className='w-[300px] mx-auto rounded-md hover:scale-105 transition duration-300' />
              ...
              <p>Underlining it all, we believe in Sustainability in Action and we we are here to help you make the right choices for all our futures.</p>
            </div>
          </div>
        </div>
    </div>
