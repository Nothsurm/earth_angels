...
import Image1 from '../images/Pagoda2.png'
import Image2 from '../images/luxury.png'
import Image3 from '../images/pool-with-beds.png'
    ...
    <div>
        ...
        <Parallax blur={0} strength={600} bgImage={Image} bgImageStyle={{ marginTop: '-200px' }}>
          <div className="w-full h-[600px] sm:min-h-screen flex flex-col gap-4 justify-center items-center">
            ...
            <p className='text-4xl font-bold text-center text-white bg-zinc-700 bg-opacity-40 p-2 rounded-md title-2'>is creating a better future</p>
        ...
        <div className="text-stone-100" style={myStyle}>
            <div className="h-fit flex flex-col gap-20 lg:ml-auto text-right max-w-2xl ml-2 mr-2 lg:mr-40 leading-loose font-semibold">
              <h1 className='text-4xl font-semibold mt-20'>Dedicated to Sustainable Solutions,</h1>
              <p className=''>at Earth Angels we embrace the philosophy of 'Wellness Architecture & Design' and prioritise a sustainable approach to design,  building and renovating. Our goal is to be environmentally friendly and socially responsible, while still offering affordable options to our customers that are stylish, luxurious, and indulgent.</p>
              <p className=''>Picture a home that not only saves energy but also provides year-round thermal comfort with low-cost heating and cooling systems that can be easily controlled. This energy efficiency then enhanced by the use of renewable energy sources and battery storage systems.</p>
              <p>In addition, our solutions prioritise healthy living with fresh air circulation and the use of non-toxic materials, sourced from companies that share our commitment to sustainability.</p>
              <p>We support developers, real estate agencies, home builders, and home owners in this shared goal of promoting sustainable communities.</p>
              <p>We have detailed knowledge and experience of sustainability in the Built Environment to share and embrace the design movement known as 'Wellness Architecture' (aka 'Wellness Design' or 'Wellness Real Estate').</p>
        ...
        <div className="text-stone-100" style={myStyle1}>
          <div className="h-fit flex flex-col gap-20 max-w-2xl ml-2 mr-2 lg:ml-40">
            ...
            <div className="leading-loose font-semibold flex flex-col gap-20 mb-20">
              ...
              <img src={Image1} alt="" className='w-full mx-auto rounded-md hover:scale-105 transition duration-300' />
              ...
              <img src={Image3} alt="" className='w-[350px] mx-auto rounded-md hover:scale-105 transition duration-300' />
